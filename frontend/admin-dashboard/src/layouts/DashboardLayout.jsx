          ...
          <ul className="sidebar-nav-list">
            {navItems.map((item) => (
              <li key={item.path} className="sidebar-nav-item">
                <Link 
                  to={item.path}
                  className={isActivePath(item.path) ? "sidebar-link active" : "sidebar-link"}
                >
                  ...
                  {item.label === "Users" && <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><path d="M20 8v6"></path><path d="M23 11h-6"></path></svg>}
                  {item.label === "AI Security" && <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2l7 4v6c0 5-3.5 9.2-7 10-3.5-.8-7-5-7-10V6l7-4z"></path><path d="M9 12l2 2 4-4"></path></svg>}
                  {item.label}
                </Link>
              </li>
            ))}
